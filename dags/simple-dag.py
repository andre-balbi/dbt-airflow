...
profile_config_01 = ProfileConfig(  # substitua pelo nome do profile_config adequado *
    profile_name="projeto_01",  # substitua pelo nome do projeto (pasta do dbt)
    ...
    profile_mapping=GoogleCloudServiceAccountFileProfileMapping(
        ...
        profile_args={
            ...
            "keyfile": "/usr/local/airflow/dbt/project_01/dbt-airflow-469721-628d9321fc47.json"  # substitua pelo caminho (docker) do seu arquivo de chave de conta de serviço
        }
    )
)
...
my_cosmos_dag = DbtDag(
    ...
    schedule_interval="@daily",  # substitua pelo schedule_interval desejado para a DAG
